...
| cbomRepo.endpoint                            | `http://minio-service:9000` | Base endpoint for CBOM S3 storage                                     |
| cbomRepo.region                              | `eu-west-1`                 | Region for CBOM S3 storage                                            |
| cbomRepo.bucket                              | `cbom-repo`                 | Bucket name for CBOM S3 storage                                       |
